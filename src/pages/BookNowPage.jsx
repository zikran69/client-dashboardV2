      ...
      <div className='bg-primary-blue min-h-screen text-primary-orange p-4'>
        ...
        <form className='mt-4' onSubmit={(e) => e.preventDefault()}>
          <div className='grid gap-4'>
            ...
            />
            <select name='lantai' className='outline-none border p-2 rounded-md w-full mt-4'>
              <option>1</option>
              <option>2</option>
            </select>
            <input
            ...
            />
            <div>
              <label htmlFor='tanggalCheckIn' className='mt-4 text-lg font-semibold'>
                Tanggal Check In
              </label>
              <input type='date' name='tanggalCheckIn' className='outline-none border p-2 rounded-md w-full' />
            </div>
            <input
              type='number'
              name='jmlHari'
