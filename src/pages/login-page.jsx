            ...
            <div className="backdrop-blur-sm bg-white/20 p-6 rounded-xl shadow-xl w-[300px] text-sm sm:mx-3">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        <input type="text" id="userName" name="username" placeholder="user" className="mt-1 px-4 py-2 w-full border rounded-md focus:ring focus:ring-indigo-300"/>
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="my-4 text-center">
                        <span>Dont have an account? 
                            <Link to="/register"className="text-primary-blue font-semibold hover:text-pink-400 hover:underline"> Register</Link>
                        </span>
                    </div>
                </form>
            </div>
