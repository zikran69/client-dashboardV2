export default function ServiceCard({ icon, title, subTitle }) {
  return (
    <div className="font-roboto max-w-[350px] h-[350px] border lg:drop-shadow-2xl drop-shadow-xl  backdrop-sm m-4 px-8 grid gap-1 content-center text-center text-primary-orange hover:bg-primary-orange duration-500 hover:text-white rounded-lg">
